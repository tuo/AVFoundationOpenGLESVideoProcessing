...
iPhone4:
 ...
 iPad2:
  GPU: 5.09s  (alpha and fx not fully synced on some frames)
  Custom: 4.37s ~ 4.8s

 iPad3:
  GPU: 4.49s ~ 5.2s (Couldn't write a frame, corrupted)
  Custom: 3.36s ~ 3.67s
...
1. ipod5 - 5.7 seconds, action movie fx - 10.6 seconds

3. iPhone4s - 6.7s ~ 7.380 seconds , action movie fx - 17.28 seconds

2. iPhone4 - 12.0s~13.0s seconds , action movie fx - 36 seconds
...
http://stackoverflow.com/questions/21895198/nothing-is-drawn-when-using-vertex-array-objects
...
ffmpeg -i fireworks.mp4 -i sound.caf -shortest fireworks_audio.mp4